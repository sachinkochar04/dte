      ...
      <h1>Current Recurring Schedules</h1>
        ...
        <Col sm="12" md="2"className="pr-0 fr" >
            <p className="mb-0">Schedule Begins</p>
                ...
                <Col sm="12" md="1"><Col className="ar1"><FaArrowRight className="mt-4" /></Col></Col>
                <Col sm="12" md="2" className="fm">
              <p className="mb-0" >Schedule End</p>
          <input type="date" name="schedule_began" className="mx-w-100 bc-lg"  />
        </Col>
      </Row>
      <Row>
  ...
  <td><FormGroup><Col sm={1}><Input type="select" name="select" id="exampleSelect" className="ipe">
        ...
        <Row >
          ...
          <button className="eb ebc"   onClick={this.cancelSchedule} > X cancel</button>
            <button className="ebn" onClick={this.editSchedule} >Finished Editing</button>
          </Col>
        </Row>
          </Container>
    </Aux>
